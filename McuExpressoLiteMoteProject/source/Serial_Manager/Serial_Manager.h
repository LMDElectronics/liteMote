...
#define DATA_BUFFER_DESTINATION_NODE_OFFSET 1
#define DATA_BUFFER_SEND_TIME_OFFSET        2
#define DATA_BUFFER_MSG_TYPE_OFFSET         4
#define DATA_BUFFER_PAYLOAD_LENGTH_OFFSET   6
#define DATA_BUFFER_PAYLOAD_START_OFFSET    7

//data size
#define DATA_BUFFER_ORIGIN_NODE_SIZE_BYTES      1
#define DATA_BUFFER_DESTINATION_NODE_SIZE_BYTES 1
